# %% library
from loader import loader, loader_CIFAR10
import argparse
from model import *
import numpy as np
import torch
...
def main():
    ...
    parser.add_argument('--experiment', type=str, default='1_CIFAR', help='experiment name')
    ...
    if args.experiment.split('_')[0] == '1':
        args.model = CAE1(args).cuda(args.gpu_device)
        print(f'model{args.experiment} created -- gpu version!')
    elif args.experiment.split('_')[0] == '2':
        args.model = CAE2(args).cuda(args.gpu_device)
        print(f'model{args.experiment} created -- gpu version!')
    elif args.experiment.split('_')[0] == '3' :
        args.model = CAE3(args).cuda(args.gpu_device)
        print(f'model{args.experiment} created -- gpu version!')
    else:
        args.model = CAE4(args).cuda(args.gpu_device)
        print(f'model{args.experiment} created -- gpu version!')
